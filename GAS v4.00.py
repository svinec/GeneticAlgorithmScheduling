...
class GAS():
	...
	def breedPopulation( self, do_print = False ):
		...
		if do_print: self.printBestNormalized()
...
# ideal solution
# start_times = [ 25, 36, 35, 33, 23, 14, 25, 4, 8, 11, 1 ] (non-normalized form)
...
"""GAS_simple_1 = GAS( parameters_simple_1 )
GAS_simple_1.addRandomToPopulation( GAS_simple_1.populationSize )
for generation in range( 100 ):
	GAS_simple_1.breedPopulation( True )"""


# in order to do automated test, do something like:
